        ...
        <div className="container">
            ...
            <div className="contractor-settings">
                ...
                :
                    ...
                    <button  className='btn btn_sizeSm' onClick={() => handleStatusChange({translator: project.translator_status, proofreader: project.proofreader_status})}>{buttonStatus}</button>
                }
            </div>
        </div>
    );
