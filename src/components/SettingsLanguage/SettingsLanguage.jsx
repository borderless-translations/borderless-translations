    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <button button className='btn btn_sizeSm' type="submit">Add Language</button>
            </form>
            <table>
                <thead>
                    <tr>
                    ...
                    {languages.map(language => (
                        <tr key={language.id}>
                            {editLanguageId === language.id ? (
                                ...
                                <td>
                                    <button button className='btn btn_sizeSm' onClick={() => handleSave(language.id)}>Save</button>
                                ...
                                <>
                                    ...
                                    <td>{language.tier}</td>
                                    <td>
                                        <button button className='btn btn_sizeSm' onClick={() => handleEdit(language)}>Edit</button>
                                        <button button className='btn btn_sizeSm' onClick={() => handleDelete(language.id)}>Delete</button>
                                    </td>
                                </>
                            )}
                        </tr>
