...
function AdminProjectPage(){
    ...
    return(
        ...
        <div>
            ...
            <button button className='btn btn_sizeSm' onClick={() => handleAddProject()}>Add Project</button>
                    ...
                    {projects.map(project => {
                        return (
                            <TableRow key={project.id}>
                                ...
                                <TableCell align="center"><button button className='btn btn_sizeSm' onClick={() => handleEditProject(project)}>Edit Project</button></TableCell>
                            </TableRow>
                        )
                    })}
                </TableBody>
